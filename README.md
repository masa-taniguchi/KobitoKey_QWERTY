...
このプロジェクトは、**mainブランチ**と**developブランチ**の2つのブランチで管理しています。

### mainブランチ

**用途**: 五十川様のfirmwareを自分用に微調整したもの

**主な仕様**:
- ZMK v0.3ベース
- 左側トラックボール: 常時スクロール機能
- 右側トラックボール: 常時ポインティング機能
- 基本的なレイヤー構成（Layer 0-3）
- 五十川様のfirmwareを追従する形式の設定

**推奨用途**:
- 安定した動作が必要な場合
- developブランチが使用できなくなった時のバックアップ

### developブランチ

**用途**: 右手トラックボールのスクロールの設定などの少し重めの変更をくわえているもの

**主な仕様**:
- ZMK mainブランチベース（最新機能）
- 左側トラックボール: 常時スクロール機能
- 右側トラックボール: 
  - デフォルト（Layer 3以外）: ポインティング機能
  - Layer 3: スクロール機能
- 最新のZMK機能を活用した設定
